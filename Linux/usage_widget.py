"""Codex & Claude usage tracker for Linux; Qt display with Tk settings."""
import argparse
...
CONFIG_FILE = Path(os.environ.get('XDG_CONFIG_HOME') or Path.home() / '.config') / 'codex-usage-tracker/config.json'
